...
For method and workflow establishment purpose, use group A~S in database only

2020.06.18 update: apply 3rd Approach as benchmark for 4th Approach

Version log: Updated on Jun. 19, 2020
=========================================================================
ver.        date         features
=========================================================================
0.2        2020.06.19    Add learning curve analysis
0.1        2020.06.18    Drop feature columns with single level (stdev = 0)
0.0        2020.06.15    New release
"""
...
# from sklearn.dummy import DummyRegressor # for comparing with other regressors
# from sklearn.linear_model import Lasso, Ridge, LassoCV, RidgeCV # regularized
# from sklearn.linear_model import LinearRegression, SGDRegressor, HuberRegressor
# from sklearn.kernel_ridge import KernelRidge # KRR method (c.f. Ridge & SVR)
...
if __name__ == '__main__': # script run of this file (for function testing)
    ...
    # Note that at each fold the scalers (determined by training set ONLY)
    # are different! Validation set uses scalers from training set; i.e.
    # XS_train = scaler.fit.transform(X_train)
    ...
    # 2020.06.19 add learning curve analysis:
